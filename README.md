...
1. **抓新聞**：用「回溯抓取」精準抓「前一天16:00到今天16:00（台灣時間）」這個區間的新聞
...
會抓「2026-06-14 16:00 到 2026-06-15 16:00（台灣時間）」這個區間內、依實際發布時間精篩過的新聞，
...
`.github/workflows/daily.yml` 排程於**台灣時間每日 16:00 執行一次**（UTC 08:00；GitHub cron 常延遲
5～20 分鐘，實際會晚一點跑，屬正常現象），用回溯抓取精準拿「前一天16:00到今天16:00」這個區間的新聞，接著：
